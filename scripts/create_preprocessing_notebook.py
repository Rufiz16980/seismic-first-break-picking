"""Generate the 02_preprocessing_pipeline.ipynb notebook.

Run this script from the project root:
    python scripts/create_preprocessing_notebook.py

The notebook will be created at notebooks/02_preprocessing_pipeline.ipynb.
It is designed to be run on Google Colab with Drive mounted.
"""
...
def make_cell(source_lines, cell_type="code", metadata=None):
...
def build_notebook():
    """Build the complete preprocessing pipeline notebook."""
    cells = []
    ...
    # ----------------------------------------------------------------
    # Cell 7: Validation — spot-check random gathers
    # ----------------------------------------------------------------
    cells.append(make_cell([
    ...
    # ----------------------------------------------------------------
    # Cell 8: Verify split balance & label distributions
    # ----------------------------------------------------------------
    cells.append(make_cell([
...
def main():
    """Generate and save the preprocessing pipeline notebook."""
    # Determine project root
    script_dir = os.path.dirname(os.path.abspath(__file__))
    project_root = os.path.dirname(script_dir)

    notebook = build_notebook()
    output_path = os.path.join(project_root, "notebooks",
